         ...
         <Grid lg={5} sm={5} xs={12} item>
            ...
            <RightContainer lg={7} md={7} sm={7} xs={12} item>
             <Text>
                ...
                <Author>
                    <b>short</b> by { data.author} <b>/ </b>{new Date(data.timestamp).toDateString()}
                    </Author> 
             <Typography>{data.description}</Typography>
             <Publisher>read more at &nbsp;
               <a style={{ textDecoration: 'none',color:'#000'}} href={data.link} target=" blank"><b>{data.publisher}</b></a></Publisher>
